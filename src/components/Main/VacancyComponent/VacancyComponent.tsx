        ...
        <div className="vacancy">
            <div className="vacancy-main">
                ...
                <div className="vacancy-main__location">
                    ...
                    <span className="vacancy-main__location-name">{props.vacancy.location + ', ' + props.vacancy.address}</span>
                </div>
            </div>
            <div className="vacancy-side">
                <span className="vacancy-side__salary">{props.vacancy.salaryFrom + ' - ' + props.vacancy.salaryTo + ' Р'}</span>
